...
seed = nil
-- seed = 0
l1 = lcg(seed) -- Linear congruential generator (Ansi C params)
l2 = lcg(seed, 'nr') --Linear congruential generator (Numerical recipes params)
c1 = mwc(seed) -- Multiply-with-carry (Ansi C params)
c2 = mwc(seed, 'nr') -- Multiply-with-carry (Numerical recipes params)
m = twister(seed) -- Mersenne twister
